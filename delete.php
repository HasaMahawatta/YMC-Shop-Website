...
$db = new mysqli("localhost", "root", "", "register");
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  $sql = "DELETE FROM users WHERE password='$mypassword'";
    ...
    <header>
      ...
      <nav>
        <ul id="menu">
          ...
          <li ><a href="loginpage.php">Update</a></li>
          <li id="menu_active"><a href="Delete.php">Delete</a></li>
         ...
         <div style = "width:300px; border: solid 0px #333333; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <form action = "delete.php" method = "post">
			      <label>Enter Your Password  :</label><input type = "password" name = "password" class = "box" /><br/>
			
               
				
                  <input type = "submit" value = " Delete My Account"/><br />
               </form>
